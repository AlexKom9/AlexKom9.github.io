...
var _selectNew = __webpack_require__(29);
...
var _switchState = __webpack_require__(27);

var _switchState2 = _interopRequireDefault(_switchState);

var _AppSelect = __webpack_require__(28);

var _AppSelect2 = _interopRequireDefault(_AppSelect);

var _OrderRow = __webpack_require__(30);

var _OrderRow2 = _interopRequireDefault(_OrderRow);

var _AppLoader = __webpack_require__(31);
...
exports.default = Vue.component('OrdersApp', {
    name: 'OrdersApp',
    data: function data() {
        return {
            transactionType: 'buy',
    ...
    methods: {
        getData: function getData() {
            ...
            this.loading = true;
            this.data = [];
            _axios2.default.get('http://front.bigrate.loc/api/orders?category=' + this.category + '&country=0&page=1&limit=' + this.limit).then(function (response) {
        ...
        getMoreData: function getMoreData() {
            ...
            this.loading = true;
            _axios2.default.get('http://front.bigrate.loc/api/orders?category=' + this.category + '&country=0&page=' + this.page + '&limit=' + this.limit).then(function (response) {
