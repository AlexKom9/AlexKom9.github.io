  ...
  return {
    initialState: function initialState() {
      if ($(window).outerWidth() < 1023) {
        $('.cabinet__nav-item span').hide();
        $('.cabinet_edit-btn span').hide();
      }
    },
    init: function init() {
      this.initialState();
...
var _OrderRow = __webpack_require__(15);

var _OrderRow2 = _interopRequireDefault(_OrderRow);

var _AppLoader = __webpack_require__(16);
