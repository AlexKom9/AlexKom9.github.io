...
const strictUriEncode = __webpack_require__(51);
const decodeComponent = __webpack_require__(52);
...
var _perfectScrollbar = __webpack_require__(2);
    ...
    return {
        ...
        notification: function notification() {
            ...
            $(window).on('resize', function () {
                _this.notificationPosition();
            });
            if (document.querySelector('#js-notification-scroll')) {
                var ps = new _perfectScrollbar2.default('#js-notification-scroll');
            }
        },
        notificationPosition: function notificationPosition() {
            if ($(window).outerWidth() < 600) {
                var containerPosition = $('#js-header-notifications')[0].getBoundingClientRect();
                var dropWidth = $(window).innerWidth() - 6;
                $('#js-header-notifications-drop').css({ "left": -containerPosition.x + 3, "max-width": dropWidth, "width": dropWidth });

                $('#notifications-drop-triangle').css({ 'left': containerPosition.x, 'right': 'unset' });
            } else {
                $('#js-header-notifications-drop').attr('style', '');
                $('#notifications-drop-triangle').attr('style', '');
            }
        },
        ...
        init: function init() {
            this.userMenu();
            this.mobileMenu();
            if (document.querySelector('#js-header-notifications')) {
                this.notification();
...
var transactionsUrl = exports.transactionsUrl = BASE_URL + "api/transactions";
...
var _alerts = __webpack_require__(21);
...
var _selectNew = __webpack_require__(4);

var _selectNew2 = _interopRequireDefault(_selectNew);

var _cardToggle = __webpack_require__(22);

var _cardToggle2 = _interopRequireDefault(_cardToggle);

var _prevCard = __webpack_require__(23);

var _prevCard2 = _interopRequireDefault(_prevCard);

var _cabinet = __webpack_require__(24);
...
$(document).ready(function () {
  ...
  (0, _prevCard2.default)().init();
  (0, _cabinet2.default)().init();
...
var Modals = function Modals() {
	return {
		modalEvents: function modalEvents() {
			...
			$('.modal__close').on('click', this.closeModals);
		},
...
function Alerts() {
  ...
  return {
    ...
    showRejectAlert: function showRejectAlert(text, time) {
      if (!time) {
        time = defaultTime;
      }
      this.hideAllAlerts();
...
var cardToggle = function cardToggle() {
  var header = $('.card__head--toggle-mobile');
  var card = $('.card--toggle-mobile');
  var cardInner = $('.card__inner--toggle-mobile');
  var headerActiveClassName = 'card__head--toggle-mobile-active';
  var headerClassName = 'card__head--toggle-mobile';
  ...
  return {
    ...
    initialMobileState: function initialMobileState() {

      if ($(window).outerWidth() < 720) {
        $('.card__head--toggle-mobile').each(function () {
          $(this).closest('.card').find('.card__inner').hide();
          if ($(this).hasClass('card__head--toggle-mobile-active')) {
            $(this).closest('.card').find('.card__inner').show();
          }
        });
      }
...
function prevCard() {
  var boxClass = '.prev-card__descr';
  return {
    ellipsizeTextBox: function ellipsizeTextBox(className) {
    ...
    resize: function resize() {
      ...
      $(window).on('resize', function () {
        _this.ellipsizeTextBox(boxClass);
      });
    },
    init: function init() {
      this.ellipsizeTextBox(boxClass);
      this.resize();
    }
  };
}

exports.default = prevCard;
...
var Cabinet = function Cabinet() {
  var topIndent = 10;
  return {
    floatNav: function floatNav() {

      var navScroll = new _perfectScrollbar2.default('#js-side-nav');

      var cardsInner = document.querySelector('.cards__inner');
      var cardsInnerSourceBottom = cardsInner.getBoundingClientRect().bottom + window.pageYOffset;
      var sideNav = document.getElementById('js-side-nav');
      var sideNavSourceTop = sideNav.getBoundingClientRect().top + window.pageYOffset;

      function setNavWidth() {
        var cabinetSideWidth = $('#js-cabinet-side').width();
        $(sideNav).css('width', cabinetSideWidth);
      }

      function updateSourceData() {
        cardsInner = document.querySelector('.cards__inner');
        cardsInnerSourceBottom = cardsInner.getBoundingClientRect().bottom + window.pageYOffset;
        sideNav = document.getElementById('js-side-nav');
        sideNavSourceTop = sideNav.getBoundingClientRect().top + window.pageYOffset;
      }

      function resetNavState() {
        sideNav.classList.remove('fixed');
        sideNav.classList.remove('absolute-bottom');
        navScroll.update();
      }
      ...
      window.onscroll = function () {
        ...
        if (sideNav.getBoundingClientRect().bottom + window.pageYOffset >= cardsInnerSourceBottom && !sideNav.classList.contains('absolute-bottom') && sideNav.classList.contains('fixed')) {
          sideNav.classList.add('absolute-bottom');
          sideNav.classList.remove('fixed');
        } else if (sideNav.getBoundingClientRect().top + window.pageYOffset >= window.pageYOffset && sideNav.classList.contains('absolute-bottom') && !sideNav.classList.contains('fixed')) {
          sideNav.classList.remove('absolute-bottom');
          sideNav.classList.add('fixed');
        }

        if (sideNav.classList.contains('fixed') && window.pageYOffset - sideNavSourceTop <= -topIndent) {
          sideNav.classList.remove('fixed');
        } else if (window.pageYOffset - sideNavSourceTop >= -topIndent && !sideNav.classList.contains('absolute-bottom')) {
          sideNav.classList.add('fixed');
        }
      };
    },
...
$(document).ready(function () {
  if ($('.js-card-tab__tabs-wrap').length > 0) {
    var ps = new _perfectScrollbar2.default('.js-card-tab__tabs-wrap', {
      suppressScrollX: false,
...
var _OrdersApp = __webpack_require__(32);

var _OrdersApp2 = _interopRequireDefault(_OrdersApp);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

$(document).ready(function () {
  if (document.querySelector('#OrderApp')) {
    var app = new _vue2.default({
      el: '#OrderApp',
      render: function render(h) {
        return h(_OrdersApp2.default);
      }
    });
  }
});
...
exports.default = _vue2.default.component("OrdersApp", {
  name: "OrdersApp",
  data: function data() {
    return {
      transactionType: "buy",
  ...
  components: {
    SwitchState: _switchState2.default,
    AppSelect: _AppSelect2.default,
    OrderRow: _OrderRow2.default,
    AppLoader: _AppLoader2.default
  },
  template: "\n        <section class=\"orders\">\n            <div class=\"l-container l-container--full-600\">\n              <div class=\"l-container-center\">\n                  <div class=\"l-inner l-inner--10\">\n                    <div class=\"orders__inner\">\n                      <div class=\"orders__h-control\">\n                        <div class=\"orders__h-control-switch\">\n                        \n                        <!--SwitchState componnet-->\n                          <SwitchState v-on:switchState=\"dealType = $event\"/>\n                          \n                        </div>\n                        <div class=\"orders__h-control-country\">\n                          <AppSelect v-on:changeCountry=\"changeCountry\"/>\n                          \n                        </div>\n                      </div>\n                      <div class=\"info-tab__table\">\n                        <div class=\"card-tab\">\n                            <div id=\"js-orderApp-card-tab__tabs-wrap\">\n                                <div class=\"card-tab__tabs\">\n        \n                                  <div \n                                    class=\"card-tab__tab\"\n                                    v-bind:class=\"{'card-tab__tab--active': transactionType === 'buy'}\"\n                                    v-on:click=\"changeTransactionType('buy')\">\n                                    <span>\u041A\u0443\u043F\u0438\u0442\u044C \u0431\u0438\u0442\u043A\u043E\u0438\u043D</span>\n                                  </div>\n                                  <div \n                                    class=\"card-tab__tab\"\n                                    v-bind:class=\"{'card-tab__tab--active': transactionType === 'sell'}\"\n                                    v-on:click=\"changeTransactionType('sell')\">\n                                    <span>\u041F\u0440\u043E\u0434\u0430\u0442\u044C \u0431\u0438\u0442\u043A\u043E\u0438\u043D</span>\n                                  </div>\n                                  <div \n                                    class=\"card-tab__tab\"\n                                    v-bind:class=\"{'card-tab__tab--active': transactionType === 'credit'}\"\n                                    v-on:click=\"changeTransactionType('credit')\">\n                                    <span>\u041A\u0440\u0435\u0434\u0438\u0442\u043E\u0432\u0430\u043D\u0438\u0435</span>\n                                  </div>\n                                  <div \n                                    class=\"card-tab__tab\"\n                                    v-bind:class=\"{'card-tab__tab--active': transactionType === 'borrow'}\"\n                                    v-on:click=\"changeTransactionType('borrow')\">\n                                    <span>\u0417\u0430\u0439\u043C</span>\n                                  </div>\n                                </div>\n                              </div>\n                          </div>\n                          \n                          <div class=\"card-tab__inner card-tab__inner--nopaddig-600\">\n                            \n                            <div class=\"card-tab__content\">\n        \n                              <!--i-tab__head-->\n                              <div class=\"i-tab__head i-tab__row\">\n                                <div class=\"i-tab__head-cell i-tab__cell\"><span>\u041F\u0440\u043E\u0434\u0430\u0432\u0435\u0446</span></div>\n                                <div class=\"i-tab__head-cell i-tab__cell\"><span>\u0421\u043F\u043E\u0441\u043E\u0431 \u043E\u043F\u043B\u0430\u0442\u044B</span></div>\n                                <div class=\"i-tab__head-cell i-tab__head-cell--sort i-tab__head-cell--up i-tab__cell\"><span>\u0426\u0435\u043D\u0430 /BTC</span></div>\n                                <div class=\"i-tab__head-cell i-tab__cell\"><span>\u041B\u0438\u043C\u0438\u0442</span></div>\n                              </div>\n    \n                              <!--/end i-tab__head-->\n                              <div class=\"i-tab__loader\" v-if=\"loading\">\n                                <AppLoader/>\n                              </div>\n                              <div class=\"i-tab__not-found\" v-if=\"!data.length && !loading\">\n                                <span>\u041E\u0431\u044A\u044F\u0432\u043B\u0435\u043D\u0438\u044F \u043D\u0435 \u043D\u0430\u0439\u0434\u0435\u043D\u044B</span>                            \n                              </div>\n                              \n                              <!--i-tab__row-->\n                                <OrderRow v-for=\"item in data\" :key=\"item.id\" :item=\"item\"/>\n    \n                            </div>\n                            \n                            <div class=\"i-tab__footer\" v-if=\"counter < total\">\n                                <button class=\"l-btn l-btn--arr\" v-on:click=\"page++\">\n                                  <div class=\"l-btn__inner\">\n                                    <img src=\"img/icons/reload-more.png\"/><span>\u041F\u043E\u043A\u0430\u0437\u0430\u0442\u044C \u0431\u043E\u043B\u044C\u0448\u0435</span>\n                                  </div>\n                                </button>\n                            </div>\n                          </div>\n                        </div>\n                      </div>\n                    </div>\n                  </div>\n                </div>\n            </div>\n      </section>\n    ",
  computed: {
    category: function category() {
      if (this.dealType === "online") {
  ...
  methods: {
    getData: function getData() {
      ...
      _axios2.default.get(_api.ordersUrl + "?" + _queryString2.default.stringify(queryParam)).then(function (response) {
        _this.data = response.data.items;
        _this.counter = response.data.items.length;
    ...
    getMoreData: function getMoreData() {
      ...
      _axios2.default.get(_api.ordersUrl + "?" + _queryString2.default.stringify(queryParam)).then(function (response) {
        _this2.data = [].concat(_toConsumableArray(_this2.data)).concat(response.data.items);
        _this2.counter = _this2.data.length;
    ...
    changeTransactionType: function changeTransactionType(data) {
      this.transactionType = data;
    },
    initializeScrollBar: function initializeScrollBar() {
      var ps = new _perfectScrollbar2.default("#js-orderApp-card-tab__tabs-wrap", {
        suppressScrollX: false,
        suppressScrollY: true
      });
    },
...
exports.default = {
    ...
    template: '\n        <div class="switch">\n            <input id="swOnline"type="radio" name="typeSwitch" checked="checked"/>\n            <label \n              class="switch-state" \n              for="swOnline"\n              v-on:click="state = \'online\'">\n              <span>\u041E\u043D\u043B\u0430\u0439\u043D</span>\n            </label>\n            \n            <input id="swLocal" type="radio" name="typeSwitch"/>\n            <label \n              class="switch-state" \n              for="swLocal"\n              v-on:click="state = \'offline\'">\n              <span>\u041B\u043E\u043A\u0430\u043B\u044C\u043D\u043E</span>\n            </label>\n      </div>\n    ',
    watch: {
...
exports.default = {
  ...
  template: "\n        <div class=\"country\"><span>\u0421\u0442\u0440\u0430\u043D\u0430 :</span>\n          <div class=\"form__input-box\">\n            <div id=\"appCountry\" class=\"form__input-sel custom-select\">\n              <select v-on:change=\"selectChange\">\n                <option \n                  v-for=\"item in items\"\n                  :value=\"item.id\" \n                >\n                    {{item.name}}\n                </option>\n              </select>\n            </div>\n          </div>\n        </div>\n    ",

  methods: {
    getCountries: function getCountries() {
      var _this = this;

      _index2.default.get('http://front.bigrate.loc/api/countries').then(function (response) {
        _this.items = response.data.items;
      }).catch(function (error) {
        _this.errored = true;
      }).finally(this.initCustomSelect);
    },
    initCustomSelect: function initCustomSelect() {
      $('#appCountry').each((0, _selectNew2.default)().createSelect);
    },
...
var _OrdersSearchResult = __webpack_require__(56);

var _OrdersSearchResult2 = _interopRequireDefault(_OrdersSearchResult);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

$(document).ready(function () {
  if (document.querySelector('#OrdersSearchResultApp')) {
    var app = new _vue2.default({
      el: '#OrdersSearchResultApp',
      render: function render(h) {
        return h(_OrdersSearchResult2.default);
      }
    });
  }
});
...
exports.default = _vue2.default.component("OrdersSearchResult", {
  ...
  template: "\n    <section class=\"orders\">\n      <div class=\"l-container l-container--full-600\">\n        <div class=\"l-container-center\">\n          <div class=\"l-inner l-inner--10\">\n            <div class=\"orders__inner\">\n              <div class=\"info-tab__table\">\n                <div class=\"card-tab__inner card-tab__inner--nopaddig-600 card-tab__inner--no-shadow-600\">\n                    \n                    <div class=\"card-tab__content\">\n                      <!--i-tab__head-->\n                      <div class=\"i-tab__head i-tab__row\">\n                        <div class=\"i-tab__head-cell i-tab__cell\"><span>\u041F\u0440\u043E\u0434\u0430\u0432\u0435\u0446</span></div>\n                        <div class=\"i-tab__head-cell i-tab__cell\"><span>\u0421\u043F\u043E\u0441\u043E\u0431 \u043E\u043F\u043B\u0430\u0442\u044B</span></div>\n                        <div class=\"i-tab__head-cell i-tab__head-cell--sort i-tab__head-cell--up i-tab__cell\"><span>\u0426\u0435\u043D\u0430 /BTC</span></div>\n                        <div class=\"i-tab__head-cell i-tab__cell\"><span>\u041B\u0438\u043C\u0438\u0442</span></div>\n                      </div>\n\n                      <!--/end i-tab__head-->\n                      <div class=\"i-tab__loader\" v-if=\"loading\">\n                        <AppLoader/>\n                      </div>\n                      \n                      <div class=\"i-tab__not-found\" v-if=\"!data.length && !loading\">\n                        <span>\u041E\u0431\u044A\u044F\u0432\u043B\u0435\u043D\u0438\u044F \u043D\u0435 \u043D\u0430\u0439\u0434\u0435\u043D\u044B</span>                            \n                      </div>\n                      \n                      <!--i-tab__row-->\n                      <OrderRow \n                        v-for=\"item in data\"\n                        :key=\"item.id\"\n                        :item=\"item\"/>\n\n                    </div>\n                    \n                    <div class=\"i-tab__footer\" v-if=\"counter < total\">\n                        <button class=\"l-btn l-btn--arr\" v-on:click=\"page++\">\n                          <div class=\"l-btn__inner\">\n                            <img src=\"img/icons/reload-more.png\"/><span>\u041F\u043E\u043A\u0430\u0437\u0430\u0442\u044C \u0431\u043E\u043B\u044C\u0448\u0435</span>\n                          </div>\n                        </button>\n                    </div>\n                  </div>\n              </div>\n            </div>\n          </div>\n        </div>\n      </div>\n    </section>",
  computed: {},
  mounted: function mounted() {
    var _this = this;
  ...
  methods: {
    getData: function getData() {
      ...
      _axios2.default.get(BASE_URL + "api/orders?" + _queryString2.default.stringify(queryParam)).then(function (response) {
        _this2.data = response.data.items;
        _this2.counter = response.data.items.length;
        _this2.total = response.data.total;
    ...
    getMoreData: function getMoreData() {
      ...
      _axios2.default.get(BASE_URL + "api/orders?" + _queryString2.default.stringify(queryParam)).then(function (response) {
        _this3.data = [].concat(_toConsumableArray(_this3.data)).concat(response.data.items);
        _this3.counter = _this3.data.length;
      }).catch(function (error) {
        _this3.errored = true;
      }).finally(function () {
    ...
    getFormData: function getFormData() {
      ...
      this.processor = Number(processor);
    }
  },
  watch: {
    page: function page() {
...
function InfoPage() {
  ...
  return {
    ...
    scrollTable: function scrollTable() {
      if (document.querySelector('.js-c-tab--completed-deal')) {
        var ps = new _perfectScrollbar2.default('.js-c-tab--completed-deal', {
          suppressScrollX: false,
          suppressScrollY: true
        });
      }
...
function InfoPage() {
  ...
  return {
    ...
    scrollTable: function scrollTable() {
      if (document.querySelector("#varifed-ads__table-wrap")) {
        var ps = new _perfectScrollbar2.default('#varifed-ads__table-wrap', {
          suppressScrollX: false,
          suppressScrollY: true
        });
      }
...
$(document).ready(function () {
  if (document.querySelector('#js-chat-window-scroll')) {
    var chatWindowScroll = new _perfectScrollbar2.default('#js-chat-window-scroll', {
      wheelSpeed: 0.5
    });
    // chatWindowScroll.scrollTop = 100;
    window.chatWindowScroll = chatWindowScroll;
  }
});
...
console.log('card_place-ad_page');
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;/*! tooltipster v4.2.6 */!function(a,b){ true?!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(62)], __WEBPACK_AMD_DEFINE_RESULT__ = (function(a){return b(a)}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),
...
var _TransactionsApp = __webpack_require__(64);

var _TransactionsApp2 = _interopRequireDefault(_TransactionsApp);
...
//
//
// console.log(document.getElementById('wallet-transaction-app'));
// ReactDOM.render(<App/>, document.getElementById('wallet-transaction-app'));


$(document).ready(function () {
  if (document.querySelector('#wallet-transaction-app')) {
    var app = new _vue2.default({
      el: '#wallet-transaction-app',
      render: function render(h) {
        return h(_TransactionsApp2.default);
      }
    });
  }
});
// import OrdersApp |from "../../js/vue/components/OrdersApp";
...
var _vue2Datepicker = __webpack_require__(65);
...
exports.default = _vue2.default.component("TransactionsApp", {
  ...
  methods: {
    choseDateHandler: function choseDateHandler(date) {
      this.date = date;
    },
    getData: function getData() {
      var _this = this;
      ...
      _axios2.default.get(_api.transactionsUrl + "?" + _queryString2.default.stringify(queryParam)).then(function (response) {
        _this.data = response.data.items;
        _this.counter = response.data.items.length;
        _this.total = response.data.total;
      }).catch(function (error) {
  ...
  template: "\n   <div class=\"card card--footer transactions\">\n      <div class=\"card__head\">\n        <div class=\"card__title-wrap\">\n          <h3 class=\"card__title\">\u0422\u0440\u0430\u043D\u0437\u0430\u043A\u0446\u0438\u0438 \u043A\u043E\u0448\u0435\u043B\u044C\u043A\u0430</h3>\n        </div>\n      </div>\n      <div class=\"card__inner\">\n        <div class=\"transactions__filter\">\n          <div class=\"transactions__filter-tabs\">\n            <div class=\"transactions__filter-tab\">\n              <div \n                :class=\"['l-tab l-tab--filter', {active: this.filterState === 'all'}]\" \n                v-on:click=\"filterState ='all'\">\n                <span>\u0412\u0441\u0435</span>\n              </div>\n            </div>\n            <div class=\"transactions__filter-tab\">\n              <div \n                :class=\"['l-tab l-tab--filter', {active: this.filterState === 'sent'}]\"\n                v-on:click=\"filterState='sent'\">\n                <span>\u041E\u0442\u043F\u0440\u0430\u0432\u043B\u0435\u043D\u043D\u044B\u0435</span>\n              </div>\n            </div>\n            <div class=\"transactions__filter-tab\">\n              <div \n                :class=\"['l-tab l-tab--filter', {active: this.filterState === 'received'}]\"\n                v-on:click=\"filterState ='received'\">\n                <span>\u041F\u043E\u043B\u0443\u0447\u0435\u043D\u043D\u044B\u0435</span>\n              </div>\n            </div>\n          </div>\n          <div class=\"transactions__filter-interval\">\n            <div class=\"interval\"><span>\u041F\u0435\u0440\u0438\u043E\u0434: &nbsp</span>\n              <div class=\"interval__sel\">\n                <DatePicker :range=true :lang=this.dataPickerLang v-on:input=\"choseDateHandler\"/>\n              </div>\n            </div>\n          </div>\n        </div>\n        <div class=\"card__table\">\n          <div class=\"c-tab c-tab--transactions\">\n\n            <div class=\"i-tab__loader\" v-if=\"loading\">\n              <AppLoader/>\n            </div>\n            \n            <div class=\"i-tab__not-found\" v-if=\"!data.length && !loading\">\n              <span>\u0422\u0440\u0430\u043D\u0437\u0430\u043A\u0446\u0438\u0439 \u043D\u0435\u0442</span>                            \n            </div>\n          \n            <div v-if=\"data.length >= 1\" class=\"c-tab__row transactions__row-desktop\">\n              <div class=\"c-tab__cell\"><span>\u0414\u0430\u0442\u0430</span></div>\n              <div class=\"c-tab__cell\"><span>\u041F\u043E\u043B\u0443\u0447\u0435\u043D\u043D\u044B\u0435 BTC</span></div>\n              <div class=\"c-tab__cell\"><span>\u041E\u0442\u043F\u0440\u0430\u0432\u043B\u0435\u043D\u043D\u044B\u0435 BTC</span></div>\n              <div class=\"c-tab__cell\"><span>\u041E\u043F\u0438\u0441\u0430\u043D\u0438\u0435</span></div>\n              <div class=\"c-tab__cell\"><span>\u0421\u0443\u043C\u043C\u0430 \u043A\u043E\u043C\u0438\u0441\u0441\u0438\u0438 \u0437\u0430 \u0434\u0435\u043F\u043E\u0437\u0438\u0442, BTC</span></div>\n            </div>\n            \n            <div v-for=\"item in data\" class=\"transactions__row-mobile mb-m\">\n              <div class=\"mb-s\">\n                <p class=\"caption\">\u0414\u0430\u0442\u0430</p>\n                <p>07.07.2018</p>\n              </div>\n              <div class=\"mb-s\">\n                <p class=\"caption\">\u041F\u043E\u043B\u0443\u0447\u0435\u043D\u043D\u044B\u0435 BTC</p>\n                <p>0.15248</p>\n              </div>\n              <div class=\"mb-s\">\n                <p class=\"caption\">\u041E\u043F\u0438\u0441\u0430\u043D\u0438\u0435</p>\n                <p>\u0441\u0434\u0435\u043B\u043A\u0430 \u0441 yuriknk</p>\n              </div>\n              <div class=\"mb-s\">\n                <p class=\"caption\">\u0421\u0443\u043C\u043C\u0430 \u043A\u043E\u043C\u0438\u0441\u0441\u0438\u0438 \u0437\u0430 \u0434\u0435\u043F\u043E\u0437\u0438\u0442, BTC</p>\n                <p>0.0005</p>\n              </div>\n            </div>\n\n            <div v-for=\"item in data\" class=\"c-tab__row transactions__row-desktop\">\n              <div class=\"c-tab__cell\"><span>07.07.2018</span></div>\n              <div class=\"c-tab__cell\"><span></span></div>\n              <div class=\"c-tab__cell\"><span>0.15248</span></div>\n              <div class=\"c-tab__cell\"><span>11111</span></div>\n              <div class=\"c-tab__cell\"><span>0.0005</span></div>\n            </div>\n\n            <div v-if=\"counter < total\" class=\"card__btn\">\n              <div class=\"card__btn card__btn--center\">\n                <div class=\"l-btn\">\n                  <div class=\"l-btn__inner\">\n                    <svg class=\"svg-reload-more-dims color-primary\">\n                      <use xlink:href=\"#reload-more\"/>\n                    </svg>\n                    <span>\u041F\u043E\u043A\u0430\u0437\u0430\u0442\u044C \u0431\u043E\u043B\u044C\u0448\u0435</span>\n                  </div>\n                </div>\n              </div>\n            </div>\n          </div>\n        </div>\n      </div>\n    </div>\n  "
});
