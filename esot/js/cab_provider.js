...
// import cabModals from '../../js/cabModals.js'
var calendar = function calendar() {
	...
	$('#calendar').datepicker({
		onSelect: function onSelect(date) {
			...
			$('.holidays').append('<div class="holiday">\n\t\t\t\t\t\t<span>' + date + '</span> \n\t\t\t\t\t\t<span class="delete-date">[X]</span>\n\t\t\t\t</div>');
		}
	});
	$('#calendar').datepicker("setDate", "20.08.2018");

	$('.holidays').on('click', '.delete-date', function () {
		console.log('delete-click');
		$(this).closest('.holiday').remove();
	});
};

var itemPicker = function itemPicker() {
	$('.picked-items-box select').on('change', function (event) {
		var containerBox = $(this).parent();
		var itemsContainer = containerBox.find('.picked-items');
		...
		itemsContainer.find('.picked-items__item').each(function (index) {
			var value = $(this).data('value');
			choosedValue.push(value);
		});

		if (choosedValue.includes(value)) return;

		console.log(choosedValue);
		console.log(text);
		itemsContainer.append('\n\t\t\t<div \n\t\t\t\tclass="picked-items__item"\n\t\t\t\tdata-value="' + value + '">\n\t\t\t\t<span>' + text + '</span>\n\t\t\t\t<span class="picked-items__delete">[X]</span>\n\t\t\t</div>');
	});

	$('.picked-items').on('click', '.picked-items__delete', function () {
		var select = this.closest('.picked-items-box').querySelector('select');
		$(this).parent().remove();
...
$(document).ready(function () {
	...
	(0, _modals2.default)().showModal('comment-modal');
});
...
"use strict";
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;var _typeof=typeof Symbol==="function"&&typeof Symbol.iterator==="symbol"?function(obj){return typeof obj;}:function(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj;};/*! jQuery UI - v1.12.1 - 2018-08-05
* http://jqueryui.com
...
closeText:"Закрыть",prevText:"&#x3C;",nextText:"&#x3E;",currentText:"Сегодня",monthNames:["Январь","Февраль","Март","Апрель","Май","Июнь","Июль","Август","Сентябрь","Октябрь","Ноябрь","Декабрь"],monthNamesShort:["Янв","Фев","Мар","Апр","Май","Июн","Июл","Авг","Сен","Окт","Ноя","Дек"],dayNames:["воскресенье","понедельник","вторник","среда","четверг","пятница","суббота"],dayNamesShort:["вск","пнд","втр","срд","чтв","птн","сбт"],dayNamesMin:["Вс","Пн","Вт","Ср","Чт","Пт","Сб"],weekHeader:"Нед",dateFormat:"dd.mm.yy",firstDay:1,isRTL:false,showMonthAfterYear:false,yearSuffix:""// Additional text to append to the year in the month headers
...
/***/ })
/******/ ]);
//# sourceMappingURL=cab_provider.js.map